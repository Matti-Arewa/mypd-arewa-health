  ...
  static ContentData getSampleContent() {
    return ContentData(categories: [
      ...
      ContentCategory(
        ...
        questions: [
          ContentQuestion(
            ...
            answer: 'Ein Frauenarzt kümmert sich um die reproduktive Gesundheit von Frauen in allen Lebensphasen. Zu seinen Hauptaufgaben gehören präventive Versorgung (Krebsvorsorge, Ultraschall, gynäkologische Untersuchungen), Schwangerschaft & Geburt (Betreuung, Ultraschall, Entbindung, Nachsorge), Behandlung von Erkrankungen (Hormonstörungen, Infektionen, Endometriose, Myome), Beratung zu Verhütung & Fruchtbarkeit, Unterstützung in den Wechseljahren, psychosomatische Betreuung und Operationen wie Kaiserschnitt, Sterilisation oder Tumorentfernung.',
            categoryId: 'gynecologist',
          ),
          ContentQuestion(
            id: 'gynecologist_2',
            question: 'Was beinhaltet der erste gynäkologische Termin während der Schwangerschaft?',
            answer: 'Der erste gynäkologische Termin umfasst eine ausführliche Anamnese, Erfassung von Gewicht, Größe und Blutdruck sowie eine umfassende klinische Untersuchung, einschließlich Ultraschalluntersuchung (falls technisch möglich) zur Beurteilung der inneren Organe, Lage und Entwicklung der Schwangerschaft.',
            categoryId: 'gynecologist',
          ),
          ContentQuestion(
            id: 'gynecologist_3',
      ...
      ContentCategory(
        ...
        description: 'Informationen über die verschiedenen Phasen der Schwangerschaft (Trimester).',
        imageUrl: 'assets/images/pregnancy_stages.png',
        questions: [
          ContentQuestion(
            id: 'pregnancy_stages_1',
            question: 'Was ist ein Trimester?',
            answer: 'Ein Trimester ist ein Begriff, der die drei Phasen der Schwangerschaft beschreibt, die jeweils etwa drei Monate dauern.\n\n1. Erstes Trimester (erste 12 Wochen): In dieser Phase findet die Befruchtung statt, und die frühen Entwicklungen des Embryos und der Organe beginnen. Die Frau kann erste Symptome wie Übelkeit und Müdigkeit erfahren.\n\n2. Zweites Trimester (13. bis 26. Woche): Der Fötus wächst weiter, und viele der Beschwerden der ersten Phase lassen nach. In dieser Phase beginnen viele Frauen, ihren Babybauch zu zeigen.\n\n3. Drittes Trimester (27. Woche bis zur Geburt): Das Baby wächst weiter, und der Körper der Mutter bereitet sich auf die Geburt vor. Es kann vermehrt zu körperlichen Beschwerden wie Rückenschmerzen oder Schlafproblemen kommen.',
            categoryId: 'pregnancy_stages',
          ),
          ContentQuestion(
            id: 'pregnancy_stages_2',
            question: 'Wie viele Schwangerschaftswochen gibt es?',
            answer: 'Eine Schwangerschaft dauert etwa 40 Wochen (Schwangerschaftswochen), manchmal bis zu 42 Wochen.',
            categoryId: 'pregnancy_stages',
          ),
          ContentQuestion(
      ...
      ContentCategory(
        ...
        description: 'Grundlegende Informationen über Schwangerschaft und ihre Erkennung.',
        imageUrl: 'assets/images/pregnancy_basics.png',
        questions: [
          ContentQuestion(
            id: 'pregnancy_basics_1',
            question: 'Wie funktioniert Schwangerschaft?',
            answer: 'Eine Schwangerschaft beginnt, wenn sich eine befruchtete Eizelle in der Gebärmutterschleimhaut einnistet und sich zu einem Embryo entwickelt.',
            categoryId: 'pregnancy_basics',
          ),
          ContentQuestion(
            id: 'pregnancy_basics_2',
            question: 'Wie und wann kann ich feststellen, dass ich schwanger bin?',
            answer: 'Eine Schwangerschaft wird oft durch das Ausbleiben der Periode, Übelkeit, Müdigkeit, häufiges Wasserlassen und ein Spannungsgefühl in den Brüsten erkannt.',
            categoryId: 'pregnancy_basics',
          ),
          ContentQuestion(
            id: 'pregnancy_basics_3',
            question: 'Was sind die ersten Symptome, die bei einer möglichen Schwangerschaft auftreten?',
            answer: 'Frühe Symptome einer Schwangerschaft können Übelkeit, Erbrechen, Stimmungsschwankungen und Schmierblutungen sein.',
            categoryId: 'pregnancy_basics',
          ),
        ],
      ),
      ContentCategory(
        ...
        questions: [
          ContentQuestion(
            id: 'pre_pregnancy_1',
            question: 'Was passiert vor der Schwangerschaft?',
            answer: 'Vor der Schwangerschaft bereitet sich der Körper der Frau auf den Eisprung vor, und die Gebärmutterschleimhaut baut sich auf.',
          ...
          ContentQuestion(
            ...
            answer: 'Vor und besonders während der Schwangerschaft sollten Sie Folgendes beachten: gesunde Ernährung mit viel Obst, Gemüse, Vollkornprodukten, gesunden Fetten (z.B. Avocado) und Proteinen, gesundes Körpergewicht (BMI 18,5-24,9), moderate Bewegung (regelmäßig, aber nicht übertreiben), Stressreduktion (Meditation, Yoga, Akupunktur), Vermeidung schädlicher Substanzen (kein Nikotin und Alkohol, wenig Koffein), Minimierung von Umweltgiften, und ausreichend Schlaf (7-9 Stunden).',
            categoryId: 'pre_pregnancy',
          ),
          ContentQuestion(
            id: 'pre_pregnancy_4',
            question: 'Welche Vitamine und Nährstoffe sollte ich bereits vor der Schwangerschaft einnehmen?',
            answer: 'Die folgenden Vitamine und Nährstoffe sind im Zusammenhang mit einer Schwangerschaft wichtig:\n\n1. Folsäure: 400-800 μg (mindestens 3 Monate im Voraus)\n2. Vitamin D: 800-1.000 IE täglich\n3. Omega-3-Fettsäuren: 500-1.000 mg EPA/DHA\n4. Eisen: je nach Blutwerten\n5. Zink & Vitamin E: für die Eizellenqualität\n6. Vitamin C: unterstützt die Eisenaufnahme\n7. Jod: 150-200 μg täglich\n\nDiese Nahrungsergänzungsmittel sollten in Absprache mit Ihrem Arzt eingenommen werden.',
            categoryId: 'pre_pregnancy',
          ),
        ],
      ),
